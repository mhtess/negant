...
In our final experiment, we showed that blatantly double negative statements such as \emph{not not happy} receive an interpretation identical to that of more conventional negated antonyms (\emph{not unhappy}), even when both alternatives are presented in the same context. 
