...
\begin{quote}
\emph{Although Buck wished he could live with his family, his journal entries paint a picture of a man who has a little bored but not unhappy.}
...
Interestingly, if even logical vocabulary, like negation markers, is prone to flexible interpretation, it is to be expected that speakers will also exploit this flexibility in speech production (e.g., by saying two things at once, as in the case of ``dog whistling'').
