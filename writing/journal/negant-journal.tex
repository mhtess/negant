...
Considerable empirical work on negation has focused on \emph{negative strengthening}, where a negated adjective gets interpreted as a polar contrary \cite<e.g., not intelligent $\rightarrow$ \emph{stupid};>{Ruytenbeek2017, Gotzner2018}, and indeed we find convergent evidence in Experiment~2 (single utterances) that negated positives and morphological antonyms are interpreted similarly. However, one might expect that the presence of the morphological antonym in the same context (i.e., our \emph{multiple utterances} condition of Experiment~2) would weaken the interpretation of the negated positive, but in fact, we observe the opposite: When presented with multiple utterances, it is the morphological antonym that tends to be strengthened; the interpretation of the negated positive adjective remains unchanged, suggesting that in the absence of further context, morphological antonyms like \emph{unhappy} are interpreted more like simple contradictions.
