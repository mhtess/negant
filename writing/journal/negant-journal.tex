...
Pinning down the meanings of these simple linguistic expressions in a carefully controlled experimental setting, as we do below, will help map out the space of possible meanings available to speakers and listeners in the wild. \mf{this paragraph could be sacrificed for brevity perhaps; otherwise references to literature would be nice}
