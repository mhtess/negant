...
With these assumptions, the model derives the key ordinal predictions when the cost of morphological negation is less than the cost of particle negation \red{(see Figure X)}.
