...
Here we describe item variability in the data set from Experiment 2.

%\subsection{Experiment 2}

\subsection{Single utterance condition: Morphological antonym pairs}
...
\subsection{Single utterance condition: Lexical antonym pairs}

\subsection{Multiple utterance condition: Morphological antonym pairs}

\subsection{Multiple utterance condition: Lexical antonym pairs}
