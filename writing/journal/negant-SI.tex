...
\caption{Varying alternatives-based models inspired by Horn (1989). \mf{text in figure too
    small and probably not intelligible w/o explanation}}.\label{fig:horn}
\end{figure}
