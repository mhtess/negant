...
We contrast this context-sensitive quasi-ordering for *morphological antonyms* (*unhappy* $\approx$ *not happy* $<$ *not unhappy* $<$ *happy*) with a full-ordering predicted when overt negation is not present in antonyms (*bonafide contraries* model), as for *lexical antonyms* (*short* $<$ *not tall* $<$ *not short* $<$ *tall*). 
...
Figure \ref{fig:expt-results}A shows the mean normalized responses and bootstrapped 95\% confidence intervals for each of the four adjective types for with morphological and lexical antonyms.
...
\text{Expt$\thinspace$1} revealed an asymmetry between antonyms with overt negation markers (morphological antonyms e.g., *unhappy*) and those with unique lexical entries (lexical antonyms e.g., *short*).
Lexical antonyms (e.g., *short*) are clearly distinguished from negated positives (e.g., *not tall*), whereas morphological antonyms were not.
