...
Furthermore, the meaning of *not happy* is at least as controversial as that of *unhappy*: @Jespersen1917:Negation and @Blutner2004:pragmatics argue that the two are basically identical in meaning (i.e., antonyms and negated positives are both contradictory in nature), while @Horn1989:Natural and @Krifka2007:Negated-antonyms disagree.

Given this potential meaning underspecification of antonyms and particle negation, we hypothesize that listeners too have uncertainty about how to interpret overt negation markers and that this uncertainty is resolved in context.
...
These findings suggest that pragmatic reasoning can utilize uncertainty in logical meanings to derive finer-grained interpretations through the competition of multiple interpretations of multiple alternative utterances.
