...
Do the two negatives make a positive (i.e., Jones' happiness exceeds the same threshold)?
...
In language, *lexical antonyms* (e.g., "happy" / "sad" or "polite" / "rude") intuitively express contrary opposition: Jones can be neither happy nor sad.
Other negation-inducing linguistic devices ---*particle negation* (e.g., "not happy") and *affixal negation* (e.g., "unhappy")--- could then denote contradictory opposition.
...
Instead, affixal negation ("un-") could form a contrary, like a lexical antonym.
...
Given this indeterminacy in meaning of particle ("not") and affixal ("un-") negation, we hypothesize that listeners too have uncertainty about how to interpret over negation markers and that this uncertainty is resolved in context.
...
lexical antonyms ("happy"/"sad") as well as affixal and particle negations in different contexts, uncovering subtle but reliable differences.
