...
Two contraries cannot both be true, but they can both be false [@Horn1989:Natural]: Jones may be neither happy nor sad, neither tall nor short. 
...
Such an analysis would further depend on the meaning of *not happy* [@Blutner2004:pragmatics], of which there is little agreement: @Jespersen1917:Negation and @Blutner2004:pragmatics argue that it means the same as *unhappy*, while @Krifka2007:Negated-antonyms cites examples like: 
...
Both syntactic [@Cable2017] or pragmatic [@Rett2014:eval] mechanisms could be at play, but heretofore there have been no computational accounts tested against human behavioral data.
...
We formalize the hypothesis that uncertainty about the meaning of overt negation markers (*un-*, *not*) interacts with pragmatic reasoning to give rise to fine-grained interpretations in the moment.
...
Finally, both overt negation markers (*un-*, *not*) could be mapped to either oppositional meaning---contrary or contradiction---up to the constraints of compositionality described above (full *uncertain negation* model; all meanings shown in Fig.$\thinspace$\ref{fig:lexicon-model}).
...
We are grateful to our three reviewers and coordinator for helpful comments.
