...
rs1.implicit.simple.morph.coef
...
To do so, we considered data only from the *implicit alternatives* conditions and built a mixed-effects regression model predicted the raw, unnormalized ratings in terms of fixed effects of opposite type (negative vs. antonym), adjective type (positive, negated positive, opposite, negated opposite), and of primary theoretical interest, their interaction; the model also included random intercepts and random effects of adjective type by participant and by item.^[
