...
rs.listener.wp.expectation %>%
  mutate(utterance = factor(utterance, levels = c("Antonym", "Negated positive",
         ...
         src = factor(src, levels = c("george orwell", "bonafide antonyms", "uncertain parser"),
                      labels = c("logical negation\n(george orwell)", "bonafide antonyms", "full uncertainty"))) %>%
...
Even though the listener is uncertain about the proper interpretation for *unhappy* and *not happy*, when hearing *not unhappy*, the model reasons that a truly compositional, double negation is unlikely. 
...
The *full uncertainty model* predicts that affixal negation (e.g., *unhappy*) and particle negation (e.g., *not happy*) will receive similar interpretations, while the negated antonym (e.g., *not unhappy*) will be interpreted more weakly than the simple positive form (e.g., *happy*).
