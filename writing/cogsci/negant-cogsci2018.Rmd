...
Two negatives make a positive, or at least that is what is taught in introductory logic textbooks as classical bivalent logic.
...
Competing intuitions arise concerning the logic of negated antonyms in natural language. Horn [-@Horn1991:Duplex; -@Horn1993:Economy] provides an explanation wherein  "not unhappy" receives a restricted interpretation via its literal meaning and pragmatic competition with "happy". 
This interpretation, however, renders "not unhappy" as neutral or indifferent, contrary to intuitions that suggest "not unhappy" is a slightly positive state [e.g., @Krifka2007:Negated-antonyms].
