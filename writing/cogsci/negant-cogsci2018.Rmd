...
At a higher level of abstraction this work carries with it an interesting account of a robust linguistic intuition, namely that potentially equivalent expressions receive differential interpretations when presented in direct co-text. Reasoning about lexical ambiguity, listeners conclude that a choice of different expressions may be most likely for a speaker who differentiates meanings. \mf{you like this? more?}
