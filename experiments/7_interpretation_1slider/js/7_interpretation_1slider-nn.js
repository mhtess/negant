...
function init() {
  ...
  exp.adjective_type = [
    "positive", "neg_positive", "neg_neg_positive","antonym"//, "neg_antonym" //, "neither_pos_nor_ant"
  ];
  ...
  exp.memory_properties = _.shuffle(exp.stimuli).slice(0, 5)
